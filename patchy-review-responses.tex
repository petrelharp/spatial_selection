...
\point{}{ 
    ...
    \begin{itemize}
        \item equation (3) for the expected mutant density is only an asymptotic. Therefore, we probably need to require $|y| \gg \sigma / \sqrt(2s_m)$.
...
%%%%%%%%
\point{[expressio nfor the outflux of migrants]}{do we need this for anything?}
