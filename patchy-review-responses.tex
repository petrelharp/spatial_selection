...
We sympathize entirely: we felt the same way ourselves,
...
\reply
We've put the scaling directly back into the equations here, so this isn't an issue.
...
\reply
As discssed above, we've added this discussion to ``\nameref{ss:assumptions}''.
A few more notes:
