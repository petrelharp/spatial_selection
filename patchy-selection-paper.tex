...
as in \citet{barton1987probability,branchingbrownian};
...
is approximately $\E[1-(1-p_e)^K] \approx 2 s_p \E[K] / \xi^2$.
...
but at this point we would be violating various other assumptions above, so we omit it.
