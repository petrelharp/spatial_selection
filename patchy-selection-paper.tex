...
At equilibrium, there are $ \rho p(x) dx$ type B alleles in this area,
so the probability that the lineage of a B allele at $x$ moves to near $y$ in time $dt$
is 
\begin{align}
  r(x,y) \, dy = \frac{p(y)}{p(x)} (1+s(y)) m(y,x) \, dy .
\end{align}
