...
Using $\sigma \approx 1km$ \citep{french1968dispersal,allred1963range}, these cline widths imply $s_m=1/\sqrt{3}$ and
...
However,
for the wider cline width ($\sigma/\sqrt{s_m} = 30$km), 
...
Furthermore, given the relatively small radius of the patches of dark substrate (often $<10km$),
we should expect the haplotype to be rapidly whittled down within patches after establishment (equation \ref{}).
...
The parameters were chosen to match  XXX
