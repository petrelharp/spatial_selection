...
\maketitle
\begin{center}
$^1$ Computational Biology and Bioinformatics \\ University of
Southern California, Los Angeles, CA
$^2$Center for Population Biology \& Department of Evolution and Ecology \\ University of California -- Davis. Davis, CA, 95616
\end{center}

\abstract{
Habitats are often heterogeneous,
so that the selective pressures encountered by a species across its range
are usually not uniform.
Large enough patches of habitat with divergenct selective pressures
can lead to local adaptation,
i.e.\ a balanced polymorphism at loci responding to the selective pressure
-- a number of well-studied examples concern cryptic coloration in small mammals
whose range extends across several colors of substrate.
If there is a similar selective pressure in multiple patches,
then 
}
