...
\begin{figure}[ht!]
  ...
  \caption{
      ...
      and as predicted from equation~\eqref{eqn:mutrate} (as $1/\mutrate$, horizontal axis).
      \textbf{(B)} 
      Time until adaptation by migration from an already occupied patch to a new patch,
      as observed in simulations (vertical axis),
      and as predicted from equation~\eqref{eqn:migrate} (as $1/\migrate$, horizontal axis).
      For each,
