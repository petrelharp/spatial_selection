...
\usepackage{caption}
\DeclareCaptionType{sfigure}[Fig]
...
$\mu$ is the mutation rate, and $C$ is a constant depending on the probability of establishment and patch geometry.
...
% In Fig \ref{fig:discbyratio} we plot mean number of types and size (number of demes occupied) of a sampled type,
...
Refer again to Fig~\ref{fig:lineagesmotion}. 
