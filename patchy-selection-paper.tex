...
%%%%%%%%%%%
\abstract{
Populations within a species often repeatedly locally adapt to similar environmental conditions
across their range. Such adaptation can occur through convergent
evolution as different alleles arise and spread in different parts of
the range. Or it can occur through the spread of alleles by migration
acting to synchronizing adaptation across the species.
The tension between the two reflects the degree of 
constraint imposed on evolution by the underlying genetic
architecture versus how how effectively selection acts to inhibt the geographic spread of local
adapted alleles.
This paper studies a model of the the balance between these two routes to adaptation in continuous environments with patchy selection pressures.
We address the following questions: 
How long does it take for a new, locally adapted allele to appear in a
patch of favorable habitat through new mutation?
Or, through migration from another, already adapted patch?
Which is more likely to occur, as a function of patch separation?
...
This provides a set of tractable approximations to understand the role
of geographic separation between favorable patches in promoting
convergent adaptation and the genomic signals left.
...
in response to shared selection pressures is a testiment to the power of selection 
...
much lighter soil \citep{DiceBlossom1937,dice1940ecologic}.
...
\gc{NOT SURE IF ANYONE HAS LOOKED AT THIS NEXT PARAGRAPH IN LONG TIME?}
...
Such empricial work will also strongly inform our understanding of the
