...
architecture versus how how effectively selection acts to inhibit the geographic spread of locally
adapted alleles.
...
How long does it take for a new, locally adapted allele to appear in a
patch of habitat where it is favored through new mutation?
...
equation \eqref{eqn:mean_tau}, and use this to approximate the length of
haplotype that hitchhikes with it,
equation \eqref{eqn:haplotype_length}. We then quantify how quickly this
haplotype decays within patches equation \eqref{eqn:rec_rate_within} and
use this to obtain properties about the equilibrium distribution of
haplotype lengths, equation 
