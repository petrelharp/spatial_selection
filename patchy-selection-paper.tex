...
across their range. 
Such adaptation can occur through convergent evolution as different alleles arise and spread in different parts of the range, 
...
an important check in applications.
...
Figure~\ref{fig:mice_prob_parallel} shows the dependence of the probability
...
%commented out as wasn't quite sure what purpose this paragraph served.
%% the point was that most other work deals with bulk behavior, differential equations,
%% not tracking individuals as you have to do here.
