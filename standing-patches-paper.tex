...
and found that:
mutations appearing further than a few multiples of $\sigma/\sqrt{2|s_m|}$ away from the patch have vanishingly small probability of establishment;
mutations appearing within the patch have probability strictly less but approaching that $2s_b$ of establishment;
and if the patch width is less than $2 \tan^{-1} (\sqrt{|s_m/s_b|})$, then local fixation does not occur (rather, is not stable).
