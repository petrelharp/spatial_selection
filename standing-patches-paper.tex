...
and the solution to \eqref{eqn:defines_chi} is close to $\chi_0 = (\lambda_0 \pi)^{-1/2}$. 
\marginnote{XXX check this from below.}
% Note also substituting $z = \chi (\sqrt{2s_b} / (s_d \sigma)$ gets $z^2 + z^3 = (s_d^3 \sigma^2)/(\pi \rho \mu)$.
