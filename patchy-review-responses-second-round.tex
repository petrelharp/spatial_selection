...
%%%%%%
\point{eq.~S6 is wrong}{
    as easily seen with $\Theta=0$ \ldots
    so eq.~S6 has an extra 2, resulting from a wrong expansion of $\sqrt{1+x}$,
...
%%%%%%
\point{Minor, 4.}{
In their response to my comments, the authors said that they did not see why the assumption $R \gg w$ was neceessary. I think that it is needed in order to talk sensibly about a single "distance to a patch" $R$: if $w \simgt R$, then generally some parts of the patch will be much closer than others, right?
}
