...
We've included, for your convenience, a copy of the manuscript with the figures included,
as well as a pdf showing in red/blue the changes since the last submission.
...
\reply
Good point; we've added this, and it works out nicely: \revref.
We have looked a fair bit for a formal proof in the literature and not turned it up.
There are general results that say that for small $s$, 
a subcritical branching process looks nearly like the critical case,
where for instance $\P\{Z_n s/(1-(1-s)^{-n}) \le u \given Z_n>0\} \simeq 1-e^{-2u/\var[Z_1]}$
\citep{jagers1975branching},
but it doesn't seem like invoking these results would simplify the exposition.
