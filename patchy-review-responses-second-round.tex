...
The result does depend on target geometry, just as the reviewer points out.
The other part of this sketch
makes further simplifications to \eqref{eqn:migrate}
based on 
