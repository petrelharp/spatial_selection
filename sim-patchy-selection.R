...
with(pophist$pop$params, lines( seq(0,max(pophist$pop$params$patchdist),length.out=100), 1.5*exp(-(sqrt(2*abs(sm))/getsigma(pophist$pop$params))*seq(0,max(pophist$pop$params$patchdist),length.out=100)) ) )
with(pophist$pop$params, lines( seq(0,max(pophist$pop$params$patchdist),length.out=100), 1.5*exp(-2*(sqrt(2*abs(sm))/getsigma(pophist$pop$params))*seq(0,max(pophist$pop$params$patchdist),length.out=100)), lty=2 ) )  # fudge factor of 2
