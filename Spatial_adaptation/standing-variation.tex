...
\begin{align}
    \int_0^\infty \exp\left( - \lambda \pi v^2 (t^2/s_d + t^3) \right) dt 
       = \frac{ 1 }{ 27 s_d } \left(
            ...
            \right)
            - {}_2F_2\left(\frac{1}{2},1;\frac{2}{3},\frac{4}{3};-\frac{4 \pi v^2 \lambda}{27 s_d^3}\right)
        \right) ,
\end{align}
...
...and
\begin{align}
    \int_0^\infty \frac{2\lambda \pi v}{s_d} t \exp\left( - \lambda \pi v^2 (t^2/s_d + t^3) \right) dt \right) dt 
        = \frac{1}{v s_d} - \frac{1}{2 s_d^2} \exp\left( \frac{\pi v^2 \lambda}{4 s_d^2} \pi \sqrt{\lambda} \left( 1 - \Phi\left( \frac{ v \sqrt{\pi v} }{ 2 s_d } \right) \right) \right) .
\end{align}
