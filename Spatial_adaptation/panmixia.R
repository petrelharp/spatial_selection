...
pdf(file="Spatial_adaptation/min-s-versus-r.pdf",width=6,height=4)
rr <- 10:1000
...
pdf(file="Spatial_adaptation/f-versus-gamma.pdf",width=6,height=4)
xx <- (1:999)/1000
...
pdf(file="Spatial_adaptation/gamma-contour-1e-8.pdf", width=6, height=4)
