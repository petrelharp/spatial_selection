...
\]
The relationship between $\gamma$ and $x$ is shown in this figure:

\begin{figure}[h!]
\includegraphics[width=1.0\textwidth]{f-versus-gamma.pdf}
\caption{ Proportion difference in numbers of mutations ($x$) versus $\gamma$, on a log-log scale. }
\end{figure}

showing that if $\gamma>1$ then $x$ drops off quickly.
...
\caption{ Contour plot of $\log\gamma$ as a function of $s$ and $\sigma$. }
\end{figure}
